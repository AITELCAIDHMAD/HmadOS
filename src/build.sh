...
ld -m elf_i386 -T link.ld -o HmadOS/boot/kernel.bin kasm.o kc.o obj/isr.o obj/system.o obj/string.o obj/screen.o obj/kb.o obj/idt.o obj/util.o
qemu-system-i386 -kernel HmadOS/boot/kernel.bin
read a
